...
export const FETCH_HERO_BASE_STATS_SUCCESS = `${REQUEST_ACTION_PREFIX}/fetchHeroBaseStatsSuccess`;
export const FETCH_HERO_BASE_STATS_FAILURE = `${REQUEST_ACTION_PREFIX}/fetchHeroBaseStatsFail`;
...
export const FETCH_HERO_EQUIPPED_STATS_FAILURE = `${REQUEST_ACTION_PREFIX}/fetchHeroEquippedStatsFail`;
